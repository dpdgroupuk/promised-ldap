...
Client.prototype.search = function(base, options, controls) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var args = [base, options, controls, searchCallback].filter(function(x) {
...
Client.prototype.authenticate = function(dn, options, password) {
  var _this = this;

  return _this.bind(dn, password).then(
    function() {
      return _this.search(dn, options).then(function(result) {
